...
object Kotlin_GradleIntegrationTests : BuildType({
    uuid = "edb701dc-33b1-497e-bbbb-3036dab1c15a"
    extId = "Kotlin_GradleIntegrationTests"
    ...
    steps {
        ...
        maven {
            ...
            goals = "verify -pl :kotlin-gradle-plugin-integration-tests -Prun-gradle-integration-tests"
            pomLocation = "libraries/pom.xml"
            runnerArgs = "%mavenVerbosityOptions% -Dmaven.test.failure.ignore=true"
            mavenVersion = bundled_3_2()
            userSettingsSelection = "jb mirror"
