...
object Kotlin_GradleIntegrationTests_Android : BuildType({
    uuid = "1372f9bd-9819-4318-938b-5dec49618915"
    extId = "Kotlin_GradleIntegrationTests_Android"
    name = "(Experiment) Android Gradle Integration Tests"
    ...
    steps {
                        ...
                        <target name="create-builtins-dir">
                            <unzip src="${'$'}{kotlin-runtime.jar}" dest="dist/builtins">
                                <patternset>
                                    ...
                                    <include name="kotlin/coroutines/*.kotlin_*"/>
                                </patternset>
                            </unzip>
                        </target>
                    </project>
        ...
        maven {
            ...
            goals = "verify -pl :kotlin-gradle-plugin-integration-tests"
            pomLocation = "libraries/pom.xml"
            runnerArgs = "%mavenVerbosityOptions% -Dmaven.test.failure.ignore=true -Dtest=KotlinAndroidGradleCLIOnly,KotlinAndroidWithJackGradleCLIOnly"
            mavenVersion = bundled_3_2()
            userSettingsSelection = "jb mirror"
            userSettingsPath = ""
            jdkHome = "%env.JDK_16%"
    ...
    requirements {
        ...
        contains("cloud.amazon.agent-name-prefix", "ubuntu")
    }
