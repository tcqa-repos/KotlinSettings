...
object Kotlin_11_M1_KotlinCompilerAndPlugin : Template({
    uuid = "956d6c71-17ee-4cc9-83bd-815408ff5b79"
    extId = "Kotlin_11_M1_KotlinCompilerAndPlugin"
    name = "Kotlin Compiler and Plugin - Release"
    ...
    params {
        param("compiler.step.ant.jvm.args", "-Xmx1024m -ea -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=%teamcity.build.checkoutDir%/out")
        ...
        param("idea.build.18.artifacts", "KotlinPlugin")
    ...
    steps {
        ...
        ideaRunner {
            name = "IntelliJ IDEA Project - Java 1.8"
            id = "RUNNER_850"
            pathToProject = ""
            jdk {
                name = "1.6"
    ...
    requirements {
        doesNotEqual("cloud.amazon.agent-name-prefix", "ubuntu-10.10", "RQ_61")
    }
})
